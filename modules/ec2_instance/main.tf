...
#---------------------------------------------------------------------------------------
# Generate TLS private key for VPN
#---------------------------------------------------------------------------------------
...
#---------------------------------------------------------------------------------------
# Upload VPN private key to S3 securely
#---------------------------------------------------------------------------------------
resource "aws_s3_bucket_object" "vpn_private_key" {
  bucket                 = var.s3_bucket_name
  key                    = "${var.vpn_private_key_s3_key}-${terraform.workspace}"
  content                = tls_private_key.vpn_key.private_key_pem
  server_side_encryption = "AES256"

  depends_on = [tls_private_key.vpn_key]
}
